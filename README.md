...
> The "fake zebra printer" is a Go CLI server that listens to 127.0.0.1:9100 and prints back some processed data from the connection. It can colorize incoming ZPL codes to some extent. It is coded to simulate network printing to Zebra printers, but it does not interpret ZPL codes.
